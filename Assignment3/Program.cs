...
namespace Assignment3
{
    ...
    public abstract class Employee
    {
        ...
        public Employee(String Name = "Shradha", decimal Basic = 9000, short DeptNo = 2)
        {
            this.Name = Name;
            this.Basic = Basic;
            this.DeptNo = DeptNo;
    ...
    {
        public Manager(String Name = "sb", decimal Basic = 30000, short DeptNo = 1, string Designation = "Manager") : base(Name, Basic, DeptNo)
        {
            Console.WriteLine("*********************************************************");
    ...
    {
        public CEO(String Name = "abc ", decimal Basic = 50000, short DeptNo = 2) : base(Name, Basic, DeptNo)
        {
            Console.WriteLine("*********************************************************");
